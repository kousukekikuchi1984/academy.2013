...
<libraries>
<library name="01_Arduino-Various">
<description>&lt;b&gt;Arduino Shield Library&lt;/b&gt;
&lt;p&gt;
&lt;b&gt;Important Note:&lt;/b&gt; Some IC Schematic drawings have no visible and therefore connectable VCC (Power Supply) and GND Pins. To avoid non working PCBs and get the missing connections you have to&lt;p&gt;
&lt;ul&gt;
&lt;li&gt;Connect at least one of the Arduinos Shield GNDs with a GND symbol from the supply library&lt;/li&gt;
&lt;li&gt;Connect your Arduino Shields Output Supply Voltage  ( 5V or 3V3 ) with a VCC Symbol from the supply library&lt;/li&gt;
&lt;/ul&gt;
After that the connections will appear automatically on the board, but will not be seen at the schematic, that is ok. It's not necessary to interconnect all of the shields GND pins, they are already connected at the microcontroller board.  &lt;b&gt;Do not connect the Pins named 5V and 3V3!&lt;/b&gt;
&lt;p&gt;
&lt;i&gt;2008 by Stephanie Lange - http://www.k-ita.de/~sl/&lt;/i&gt;</description>
<packages>
<package name="SHIELD">
...
<parts>
<part name="U$1" library="01_Arduino-Various" deviceset="ARDUINO-USB" device="LONG_PADS_TEXT"/>
<part name="JP2" library="pinhead" deviceset="PINHD-2X2" device=""/>
<part name="SV1" library="con-lstb" deviceset="MA07-2" device=""/>
<part name="R2" library="rcl" deviceset="R-TRIMM" device="5W"/>
<part name="R1" library="01_adafruit" deviceset="R-US_" device="M1206" value="0Ω"/>
</parts>
<sheets>
<sheet>
<plain>
...
<instance part="JP2" gate="A" x="116.84" y="38.1"/>
<instance part="SV1" gate="G$1" x="116.84" y="83.82" rot="R180"/>
<instance part="R2" gate="G$1" x="86.36" y="88.9"/>
...
<segment>
<pinref part="U$1" gate="G$1" pin="10_PWM"/>
...
<net name="D3" class="0">
<segment>
<pinref part="U$1" gate="G$1" pin="3_PWM"/>
...
<segment>
<pinref part="U$1" gate="G$1" pin="A_5"/>
...
<segment>
<pinref part="U$1" gate="G$1" pin="A_4"/>
